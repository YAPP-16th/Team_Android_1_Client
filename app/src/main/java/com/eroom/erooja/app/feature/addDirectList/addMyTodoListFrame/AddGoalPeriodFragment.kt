package com.eroom.erooja.app.feature.addDirectList.addMyTodoListFrame
...
class AddGoalPeriodFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = AddGoalPeriodFragment()
    }
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_add_goal_period, container, false)
