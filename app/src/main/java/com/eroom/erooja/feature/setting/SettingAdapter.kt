...
class SettingAdapter (val context: Context, val settingList: Array<String>, private val click: (Int) -> Unit):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if(position % 3 == 0 && position != 0){
            val param = ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.MATCH_PARENT, ConstraintLayout.LayoutParams.WRAP_CONTENT)
